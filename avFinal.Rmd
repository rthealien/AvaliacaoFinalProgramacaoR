...
kable(gastos_estados, caption = "Gastos por estado ordenados do maior para o menor valor",format = "html", table.attr = "style='width:100%;'")
```
...
knitr::kable(
  gastos_deputados %>% mutate("Nome do Parlamentar" = txNomeParlamentar, "Valor" = valor) %>% select("Nome do Parlamentar", "Valor"),
